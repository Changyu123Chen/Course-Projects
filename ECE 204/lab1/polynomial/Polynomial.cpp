/**
	...
	Modified by Mike Cooper-Stachowsky
	Version 2.0  - 07/09/2022
*/
...
Polynomial::Polynomial (int size_p, const double coeff_p[]) {
 	size= size_p;
...
Polynomial Polynomial::add( const Polynomial& right) const {
	 	int temp_size = std::max(this->size,right.size);
